...
export default function MobileNav() {
  ...
  // The drawer and backdrop are portaled to <body>. The sticky header has a
  // backdrop-filter, which makes it the containing block for any position:fixed
  // descendant — inside it the drawer sizes to the 64px header instead of the
  // viewport, and its closed translateX(100%) sits just off the header, adding
  // horizontal scroll to every page. Portaling out is the targeted fix; the
  // header keeps its blur.
